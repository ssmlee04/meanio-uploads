...
var googleImgUrl = 'https://gsuite.google.com/setup/assets/images/misc/product-logos-350x215.png'
var googleSubpath
...
describe('<Unit Test>', function() {
  describe('Model Uploadmanager:', function() {
    ...
    describe('Method base64 to file', function() {
      ...
      it('should be able to upload file to iamge and thumb (FileToAWSImageThumb)', function(done) {
        return Uploadmanager.FileToAWSImageThumb(googleSubpath)
        .then(function(d) {
          d.image.indexOf('amazonaws.com').should.be.above(-1)
          d.thumb.indexOf('amazonaws.com').should.be.above(-1)
        }).then(function() {
      ...
      it('should be able to download from url and upload to iamge and thumb (UrlToAWSImageThumb)', function(done) {
        return Uploadmanager.UrlToAWSImageThumb(googleImgUrl)
        .then(function(d) {
          console.log(d)
          d.image.indexOf('amazonaws.com').should.be.above(-1)
          d.thumb.indexOf('amazonaws.com').should.be.above(-1)
